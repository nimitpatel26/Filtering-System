...
asmlinkage long sys_fw421_reset(void);
asmlinkage long sys_fw421_block_port(int proto, int dir, unsigned short port);
asmlinkage long sys_fw421_unblock_port(int proto, int dir, unsigned short port);
asmlinkage long sys_fw421_query(int proto, int dir, unsigned short port);
asmlinkage long sys_fc421_reset(void);
asmlinkage long sys_fc421_block_file(const char* filename);
asmlinkage long sys_fc421_unblock_file(const char* filename);
asmlinkage long sys_fc421_query(const char* filename);
asmlinkage long sys_fw421_check_blocked(int proto, int dir, unsigned short port);
asmlinkage long sys_fc421_check_blocked(const char* filename);
asmlinkage long sys_fw421_print_ports(void);
asmlinkage long sys_fc421_print_files(void);
